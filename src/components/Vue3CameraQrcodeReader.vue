...
<template>
    <div class="relative" v-show="showcam">
        <div class="text-white absolute bottom-0 bg-gray-800 p-2 rounded-xl border">
            <div class="text-sm text-center relative">
                <h1 class="text-amber-400 -translate-y-20">
                    Active Webcam
                </h1>
                <canvas ref="canvas_" class="hidden border-4 absolute top-0 left-0 z-0 rounded-lg overflow-hidden">
                </canvas>
                <div class="w-[320px] inline-block border-4 z-10 rounded-lg overflow-hidden">
                    <video ref="video_" id="videoerwyterwgwe" class=" border border-black w-[320px] h-[240px]">Video
